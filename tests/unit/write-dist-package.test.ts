...
describe("write-dist-package", () => {
  it("[REQ-040] should format semver-compatible version as base-timestamp", () => {
    const version = buildVersionWithTimestamp("0.0.1", "070326_15_04_09");
    expect(version).toBe("0.0.1-070326_15_04_09");
  });

  it("[REQ-040] should expose trace label as base:timestamp", () => {
    const label = buildTraceVersionLabel("0.0.1", "070326_15_04_09");
  ...
  it("[REQ-040] should normalize noisy timestamp input", () => {
    ...
    expect(postfix).toBe("070326_15_04_09");
  });
